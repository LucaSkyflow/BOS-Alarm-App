...
class MainWindow(ctk.CTk):
    def __init__(self, settings, alarm_store, on_test_hue=None, on_test_sound=None, on_apply_settings=None, on_quit=None, on_reset_statistics=None, on_test_full_alarm=None, on_finish_trip=None, on_check_update=None, on_test_heli_sound=None):
        super().__init__()
